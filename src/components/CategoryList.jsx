...
import { fetchTagsUrl, YOUTUBE_SEARCH_API } from '../utils/constants';
import { BiSolidChevronLeftCircle, BiSolidChevronRightCircle } from "react-icons/bi";
import ButtonsShimmer from '../components/ButtonShimmer';
...
const CategoryList = () => {
  ...
  return (
    <div className=" z-10 scrollbar-hide lg:w-[90.2vw] md:w-[84.2vw] max-sm:w-[94vw] max-sm:mx-3 bg-white md:pt-3">
      ...
      <div className="overflow-x-auto scrollbar-hide transition-transform duration-300 ease-in-out">
